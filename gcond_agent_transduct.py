...
class GCond:
    ...
    def __init__(self, data, args, device='cpu', **kwargs):
        ...
        print("feat_train_shape before reduction:", data.feat_train.shape[0])
        ...
        print('adj_syn_____2:', (n,n), 'feat_syn:', self.feat_syn.shape)
    ...
    def test_with_val(self, verbose=True):
        ...
        model.eval()
        labels_test = torch.LongTensor(data.labels_test)
...
#CHANGE SUBHANIU
    ...
    def get_sub_adj_feat(self, features):
        ...
        print("IDX selected:", idx_selected)
        print("Data_idx_train:",self.data.idx_train)
