...
class Evaluator:
    ...
    def __init__(self, data, args, device='cpu', **kwargs):
        self.data = data
        self.args = args
        self.device = device
        ...
        print('adj_param11:', self.adj_param.shape, 'feat_syn1:', self.feat_syn.shape)
    ...
    def get_syn_data(self, model_type=None):
        ...
        args = self.args
        adj_syn = torch.load(f'saved_ours/adj_{args.dataset}_{args.reduction_rate}_{args.seed}.pt', map_location='cpu')
        feat_syn = torch.load(f'saved_ours/feat_{args.dataset}_{args.reduction_rate}_{args.seed}.pt', map_location='cpu')
